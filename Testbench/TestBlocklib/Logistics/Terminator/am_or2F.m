classdef am_or2F < handle
  %% Description
  %  logical or gate
  % faulty version sending empty outputs
  %% Ports
  %  inputs:
  ...
  %% States
  %  s:     init/running
  %  i1,i2: stored input values
  %  o:     last output value
  %% System Parameters
  %  name:  object name
  %  i0:    initial value of both states
  ...
  methods
    function obj = am_or2F(name, i0, tau, debug)
      obj.s = "init";
      obj.i0 = i0;
      obj.i1 = i0;
      obj.i2 = i0;
