function out = testNserverDist3(showPlot)
  ...
  seed = 42;
	...
	load_system("NserverDist3_Model");
	model_generator("NserverDist3_Model");
	out = model_simulator("NserverDist3_Model", tEnd, "seed", seed);

  if showPlot
    width = 600;
    height = 600;
    fig = figure("name", "testNserverDist3", "NumberTitle", "off");
