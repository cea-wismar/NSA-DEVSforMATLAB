function out = testNserverDist2(showPlot)
  % input entities (id)
  if nargin == 0
    showPlot = false;
  end
  ...
  seed = 42;
	...
	load_system("NserverDist2_Model");
	model_generator("NserverDist2_Model");
	out = model_simulator("NserverDist2_Model", tEnd, "seed", seed);

  if showPlot
    width = 600;
    height = 600;
    fig = figure("name", "testNserverDist2", "NumberTitle", "off");
