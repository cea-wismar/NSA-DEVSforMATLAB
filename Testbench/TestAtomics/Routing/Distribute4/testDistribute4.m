function [out] = testDistribute4(showPlot)
    ...
    Terminator1 = devs(am_terminator("Terminator1", false, [0, 1], mdebug));
    Terminator2 = devs(am_terminator("Terminator2", false, [0, 1], mdebug));
    Terminator3 = devs(am_terminator("Terminator3", false, [0, 1], mdebug));
    Terminator4 = devs(am_terminator("Terminator4", false, [0, 1], mdebug));
